...
public class TblusuarioVista extends javax.swing.JFrame {
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        if (TXTUsuario.getText().equals("") || TXTClave.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Debe digitar el nombre y su contraseña");
            TXTUsuario.setText("");
            TXTClave.setText("");
        } else {
            boolean res = tud.login(TXTUsuario.getText(), TXTClave.getText());
            if (res == true) {
                TblproductoVista vista = new TblproductoVista();
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(null, "El nombre y/o la contraseña estan erroneas.");
                TXTUsuario.setText("");
                TXTClave.setText("");
            }
        }
